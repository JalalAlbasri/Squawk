 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "jalbasri.com", ownerName = "jalbasri.com", packagePath = "squawk"))
...
public class MessageEndpoint {
     ...
     */
//    private static final String API_KEY = "AIzaSyCuZqtLqKtHL6uzypYQLQFvG_l0NVwBaV0";
