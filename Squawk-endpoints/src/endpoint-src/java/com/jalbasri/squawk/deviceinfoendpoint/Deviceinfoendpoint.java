...
package com.jalbasri.squawk.deviceinfoendpoint;
...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://squawk-android.appspot.com/_ah/api/";
  ...
  public class GetDeviceInfo extends DeviceinfoendpointRequest<com.jalbasri.squawk.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected GetDeviceInfo(java.lang.String id) {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.jalbasri.squawk.deviceinfoendpoint.model.DeviceInfo.class);
  ...
  /**
   * Create a request for the method "getNewTweets".
   *
   * This request holds the parameters needed by the the deviceinfoendpoint server.  After setting any
   * optional parameters, call the {@link GetNewTweets#execute()} method to invoke the remote
   * operation.
   *
   * @param id
   * @return the request
   */
  public GetNewTweets getNewTweets(java.lang.String id) throws java.io.IOException {
    GetNewTweets result = new GetNewTweets(id);
    initialize(result);
    return result;
  }

  public class GetNewTweets extends DeviceinfoendpointRequest<com.jalbasri.squawk.deviceinfoendpoint.model.TweetCollection> {

    private static final String REST_PATH = "tweetcollection/{id}";

    /**
     * Create a request for the method "getNewTweets".
     *
     * This request holds the parameters needed by the the deviceinfoendpoint server.  After setting
     * any optional parameters, call the {@link GetNewTweets#execute()} method to invoke the remote
     * operation. <p> {@link
     * GetNewTweets#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param id
     * @since 1.13
     */
    protected GetNewTweets(java.lang.String id) {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.jalbasri.squawk.deviceinfoendpoint.model.TweetCollection.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
    ...
    @Override
    public GetNewTweets setAlt(java.lang.String alt) {
      return (GetNewTweets) super.setAlt(alt);
    }

    @Override
    public GetNewTweets setFields(java.lang.String fields) {
      return (GetNewTweets) super.setFields(fields);
    }

    @Override
    public GetNewTweets setKey(java.lang.String key) {
      return (GetNewTweets) super.setKey(key);
    }

    @Override
    public GetNewTweets setOauthToken(java.lang.String oauthToken) {
      return (GetNewTweets) super.setOauthToken(oauthToken);
    }

    @Override
    public GetNewTweets setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetNewTweets) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetNewTweets setQuotaUser(java.lang.String quotaUser) {
      return (GetNewTweets) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetNewTweets setUserIp(java.lang.String userIp) {
      return (GetNewTweets) super.setUserIp(userIp);
    }
    ...
    public GetNewTweets setId(java.lang.String id) {
      this.id = id;
      return this;
    }

    @Override
    public GetNewTweets set(String parameterName, Object value) {
      return (GetNewTweets) super.set(parameterName, value);
    }
  }
   ...
   * operation.
   *
   * @param content the {@link com.jalbasri.squawk.deviceinfoendpoint.model.DeviceInfo}
   * @return the request
   */
  public InsertDeviceInfo insertDeviceInfo(com.jalbasri.squawk.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    InsertDeviceInfo result = new InsertDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class InsertDeviceInfo extends DeviceinfoendpointRequest<com.jalbasri.squawk.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected InsertDeviceInfo(com.jalbasri.squawk.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, content, com.jalbasri.squawk.deviceinfoendpoint.model.DeviceInfo.class);
    }
  ...
  public class ListDeviceInfo extends DeviceinfoendpointRequest<com.jalbasri.squawk.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {
    ...
    protected ListDeviceInfo() {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.jalbasri.squawk.deviceinfoendpoint.model.CollectionResponseDeviceInfo.class);
    }
  ...
  public class RemoveDeviceInfo extends DeviceinfoendpointRequest<com.jalbasri.squawk.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected RemoveDeviceInfo(java.lang.String id) {
      super(Deviceinfoendpoint.this, "DELETE", REST_PATH, null, com.jalbasri.squawk.deviceinfoendpoint.model.DeviceInfo.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public UpdateDeviceInfo updateDeviceInfo(com.jalbasri.squawk.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    UpdateDeviceInfo result = new UpdateDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class UpdateDeviceInfo extends DeviceinfoendpointRequest<com.jalbasri.squawk.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected UpdateDeviceInfo(com.jalbasri.squawk.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "PUT", REST_PATH, content, com.jalbasri.squawk.deviceinfoendpoint.model.DeviceInfo.class);
    }
